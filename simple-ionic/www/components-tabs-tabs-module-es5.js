    ...
    var routes = [{
      ...
      children: [{
        ...
        loadChildren: function loadChildren() {
          ...
          /*! import() | tab-products-tab-products-module */
          "tab-products-tab-products-module").then(__webpack_require__.bind(null,
          /*! ./tab-products/tab-products.module */
          "./src/app/components/tabs/tab-products/tab-products.module.ts")).then(function (m) {
            return m.TabProductPageModule;
          });
        }
      }, {
        path: '',
